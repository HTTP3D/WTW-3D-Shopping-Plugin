...
class wtwshopping {
	...
	public function initHooks() {
		...
		try {
			...
			$wtwplugins->addScriptFunction("onclick", "WTWShopping.onClick(pickedname);");
			...
			$wtwplugins->addScriptFunction("disposeclean", "WTWShopping.disposeClean(moldname);");
	...
	public function editMoldPage() {
		...
		try {
			...
			$zformdata .= "			<option value=\"0\">Rounded Box Display</option>\r\n";
			$zformdata .= "			<option value=\"1\">Box Display</option>\r\n";
